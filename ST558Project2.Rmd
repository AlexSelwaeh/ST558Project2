...
corrplot(corr, type = "lower", method = "number", add = TRUE, tl.pos = "n")
```

Let's examine the correlations among the quantitative variables, create correlation plot excluding qualitative variables.

```{r}
corr1 <- cor(select(train,temp,atemp,hum,windspeed,casual,registered,cnt))
head(round(corr1, 2))
corrplot(corr1, type = "upper", tl.pos = "lt")
corrplot(corr1, type = "lower", method = "number", add = TRUE, tl.pos = "n")
```
