...
``` 
## Plots  
Box plot with the total number of users on the y-axis and the season on the x-axis - We can inspect the trend of total users across seasons using this plot.    

```{r}
library(ggplot2)

plot1 <- ggplot(train, aes(SeasonType,
                                   cnt,
                                   color=cnt)) +
  geom_boxplot() + 
